...
//         <p className="max-w-3xl mx-auto  text-xl text-center dark:text-gray-600">
...
//                 <div className="flex">
//                   <div className="flex-shrink-0">
//                     <div className="flex items-center bg-red-500 text-white justify-center w-12 h-12 rounded-md dark:bg-violet-600 dark:text-gray-50">
//                       <FaMobileAlt />
//                     </div>
//                   </div>
//                   <div className="ml-4">
