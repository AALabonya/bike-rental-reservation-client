...
//         });
//       } else {
//         // If the coupon code is invalid, set the discountCost to the total cost
//         setDiscountCost(rental?.totalCost || 0);
//         toast.error("Proceeding with the total cost.");
//       }
//     } catch (error) {
//       console.error("Error applying coupon:", error);
//       toast.error("Something went wrong. Please try again.");
...
//   const { data: couponsData } = useGetAllCouponsQuery(undefined);
// useEffect(() => {
//   if (couponsData?.data?.discount && rental?.totalCost) {
//     const calculatedDiscount =
//       rental.totalCost -
//       (rental.totalCost * couponsData?.data.discount) / 100;
//     setDiscountCost(Math.max(calculatedDiscount, 0));
//   } else {
//     setDiscountCost(rental?.totalCost || 0);
//   }
// }, [couponsData?.data?.discount, rental?.totalCost]);
// useEffect(() => {
//   if (couponsData?.data?.discount && rental?.totalCost) {
...
//   } else {
//     setDiscountCost(Math.max(rental?.totalCost - 100, 0));
//   }
// }, [couponsData?.data?.discount, rental?.totalCost]);
...
//             </h3>
//             <h3 className="text-base font-medium text-gray-900 dark:text-white">
//               {/* Your after discount Cost: {discountCost} */}
//             </h3>

//             <h3 className="text-base font-medium text-gray-900 dark:text-white">
//               Final payment: {rental?.totalCost - 100}
//             </h3>
//             <p>Use coupon</p>
//             <h3 className="text-base font-medium text-gray-900 dark:text-white">
//               Your after discount Cost: {discountCost}
...
const CouponPayment = ({ rental, open, onClose }: CouponPaymentDialogProps) => {
  ...
  // }, [couponsData?.data?.discount, rental?.totalCost]);
  useEffect(() => {
    const coupons = couponsData?.data as any; // Assert that couponsData.data is of type `any`
