...
//   console.log("yyyyyyyyyyyyy", rentData?.data);
            ...
            {rentData?.data?.length ? (
              rentData.data.map((rental: IRental) => (
                <tr key={rental._id} className="text-center">
                  <td className="px-4 py-2 border-b">
                    <div className="rounded-md overflow-hidden w-16 mx-auto">
                      {rental.bikeId?.image ? (
                        <img
                          src={rental.bikeId.image}
                          alt={rental.bikeId.name || "Bike Image"}
                          className="rounded-md transition-transform duration-200 hover:scale-105"
                        />
                      ) : (
                  ...
                  <td className="px-4 py-2 border-b">
                    {rental.bikeId?.name || "No Name Available"}
                  </td>
                  <td className="px-4 py-2 border-b">
                    {rental.userId?.name || "No User Name Available"}
                  </td>
                  <td className="px-4 py-2 border-b">
                    {rental.startTime
                      ? new Date(String(rental.startTime)).toLocaleDateString(
                  ...
                  <td className="px-4 py-2 border-b">
                    {rental.totalCost !== undefined && rental.totalCost !== null
                      ? rental.totalCost
                      : "No Cost Available"}
                  </td>
                  <td className="px-4 py-2 border-b">
